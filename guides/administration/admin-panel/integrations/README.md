...
By default the WebHooks is designed to post a message only. The _message_ is part of a JSON structure, which has the same format as described in the API documentation on how to [“Post a chat message”](https://github.com/jpreynat/docs-3/blob/master/guides/administration/admin-panel/integrations/broken-reference/README.md).
